...
const EditProfile = () => {
    ...
    const handleSubmit = (e) => {
        ...
        let { username, bio, youtube, twitter, facebook, github, instagram, website } = formData;

        if(username.length < 3){
            return toast.error("Username must be alteast 3 letters long")
        }
        ...
        axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/update-profile", {
            username, bio, social_links: {youtube, instagram, facebook, twitter, github, website}
        }, {
            headers: {
                'Authorization': `Bearer ${access_token}`
            }
                        ...
                        <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                            ...
                            <div className="w-full">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                                    ...
                                    <div>
                                        <InputBox name="email" type="text" value={fullname} placeholder="Email" disable={true} icon="fi-rr-envelope" />
                                    </div>
                                ...
                                <p className="text-dark-grey -mt-3 italic">// username will be used to search you</p>
                                ...
                                <div className="md:grid md:grid-cols-2 gap-x-6">

                                    {
                                        Object.keys(social_links).map((key, i) => {
                                            ...
                                            return <InputBox key={i} name={key} type="text" value={link} placeholder="https://" icon={"fi " + (key != 'website' ? "fi-brands-" + key : "fi-ss-browser")} />
                                        })
                                    }

                                </div>

                                <button className="btn-dark w-suto px-10 mt-4" type="submit" onClick={handleSubmit}>Update</button>
