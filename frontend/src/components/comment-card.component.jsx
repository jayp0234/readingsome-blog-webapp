...
const CommentCard = ({ index, leftVal, commentData }) => {
    ...
    const removeCommentsCards = (startingPoint, isDelete = false) => {
        ...
        if (isDelete) {
            ...
            if (parentIndex != undefined) {
                ...
                if (commentsArr[parentIndex].children.length) {
                    commentsArr[parseIndex].isReplyLoaded = false;
                }
            }
        ...
        setBlog({
            ...blog, comments: { results: commentsArr }, activity: {
        ...
        <div className="w-full" style={{ paddingLeft: `${leftVal * 10}px` }}>
            ...
            <div className="my-5 p-6 rounded-md border border-grey">
                ...
                <div className="flex gap-3 items-center mb-8">
                    ...
                    <p className="line-clamp-1 capitalize">{fullname}</p>
                ...
                <div className="flex gap-5 items-center mt-5">

                    {
                        ...
                        commentData.isReplyLoaded ?
                            ...
                            </button> : <button className="text-dark-grey p-2 px-3 hover:bg-grey/30 rounded-md flex items-center gap-2"
                                onClick={loadReplies}>
